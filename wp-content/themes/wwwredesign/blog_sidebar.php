	<div id="blog_sidebar">
	  ...
	  <div class="navigation">
	    <h4>More posts</h4>
			<?php previous_post_link('<p class="previous"><em>prev</em> %link</p>') ?>
			<?php next_post_link('<p class="next"><em>next</em> %link</p>') ?>
		</div>
	  <?php } ?>
	  
	    <p><a href="<?php bloginfo('url'); ?>/blog" title="Blog" >Blog Front page</a></p>
	    <ul>
	    <li class="feed"><a href="<?php bloginfo('rss2_url'); ?>" title="feed for blog posts">Blog posts</a></li>
	    <li class="feed"><a href="<?php bloginfo('comments_rss2_url'); ?>" title="feed for blog comments">Blog comments</a></li>
	    </ul>
		<ul>
