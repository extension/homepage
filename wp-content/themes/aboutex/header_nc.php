...
<title><?php if ( is_single() ) { ?> Blog Archive <?php } ?> <?php wp_title(); ?> - 2009 eXtension National Conference</title>

<meta name="generator" content="WordPress <?php bloginfo('version'); ?>" /> <!-- leave this for stats -->

<link rel="stylesheet" href="<?php bloginfo('template_directory'); ?>/conference.css" type="text/css" media="screen" />
...
<body <?php if (is_page('index')) echo 'id="home"'; ?>>
    ...
    <li class="group last"><span>Collaboration and Content Tools</span>
      <ul>
        <li><a href="http://ask.extension.org" title="Ask an Expert">Ask an Expert</a></li>
...
<div id="clear"></div>
<ul id="nav">
        <li><a href="<?php bloginfo('url'); ?>/2009-extension-national-conference">Conference Home</a></li>
        <li><a href="<?php bloginfo('url'); ?>/2009-extension-national-conference/agenda">Agenda</a></li>
        <li><a href="<?php bloginfo('url'); ?>/2009-extension-national-conference/breakout-sessions-at-a-glance">Sessions</a></li>
        <li><a href="<?php bloginfo('url'); ?>/2009-extension-national-conference/exhibitors">Exhibitors</a></li>
        <li><a href="<?php bloginfo('url'); ?>/2009-extension-national-conference/keynote-speakers">Keynote Speakers</a></li>
        <li><a href="<?php bloginfo('url'); ?>/2009-extension-national-conference/lodging">Travel &amp; Lodging</a></li>
        <li><a href="<?php bloginfo('url'); ?>/2009-extension-national-conference/registration">Registration</a></li>
</div>
<div id="clear2"></div>
